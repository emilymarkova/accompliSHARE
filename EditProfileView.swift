...
struct EditProfileView: View {
    ...
    var body: some View {
        VStack {
            ...
            VStack {
                EditProfileRowView(title: "Name", placeholder: viewModel.fullname, text: $viewModel.fullname)
                
                EditProfileRowView(title: "Bio", placeholder: viewModel.bio, text: $viewModel.bio)
