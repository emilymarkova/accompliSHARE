                    ...
                    HStack {
                        ...
                        VStack (alignment: .leading, spacing: 5.0) {
                            ...
                            if let minutesStudied = user.minutesStudied {
                                Text("Minutes studied today: \(minutesStudied)")
                                    .font(.footnote)
                            }
                    ...
                    HStack {
                        VStack(alignment: .leading, spacing: 4){
                            if let followerCount = user.followers.count {
                                if user.fullname != "Karlie Kloss" && user.fullname != "Margot Robbie" && user.fullname != "Taylor Swift" && user.fullname != "Dwayne Johnson"{
